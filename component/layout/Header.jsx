      ...
      <div className="max-w-screen-xl mx-auto">
        <div className="flex items-center justify-between p-4">
          ...
          <nav className="hidden md:flex md:items-center md:space-x-8 md:ml-10">
            <NavLink to="/" className="navLink" activeClassName="font-medium text-blue-600 dark:text-blue-400">
              হোম
            </NavLink>
            <NavLink to="/about" className="navLink" activeClassName="font-medium text-blue-600 dark:text-blue-400">
              লেখক সম্পর্কে
            </NavLink>
            <NavLink to="/articles" className="navLink" activeClassName="font-medium text-blue-600 dark:text-blue-400">
              প্রবন্ধ-নিবন্ধ
            </NavLink>
            <NavLink to="/miscellaneous" className="navLink" activeClassName="font-medium text-blue-600 dark:text-blue-400">
              বিবিধ
            </NavLink>
            <NavLink to="/books" className="navLink" activeClassName="font-medium text-blue-600 dark:text-blue-400">
              বই পরিচিতি
            </NavLink>
          </nav>
      ...
      {menuOpen && (
        <div className="md:hidden fixed inset-0 z-40 bg-white dark:bg-gray-900 mt-20 overflow-y-auto w-52">
          <div className="px-2 pt-2 pb-3 space-y-1">
            <NavLink to="/" className="block px-4 py-3 text-lg font-medium text-gray-800 hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-800" activeClassName="bg-gray-100 dark:bg-gray-800" onClick={() => setMenuOpen(false)}>
              হোম
            </NavLink>
            <NavLink to="/about" className="block px-4 py-3 text-lg font-medium text-gray-800 hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-800" activeClassName="bg-gray-100 dark:bg-gray-800" onClick={() => setMenuOpen(false)}>
              লেখক সম্পর্কে
            </NavLink>
            <NavLink to="/articles" className="block px-4 py-3 text-lg font-medium text-gray-800 hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-800" activeClassName="bg-gray-100 dark:bg-gray-800" onClick={() => setMenuOpen(false)}>
              প্রবন্ধ-নিবন্ধ
            </NavLink>

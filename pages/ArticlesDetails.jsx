        ...
        <div className="w-full">
          ...
          <article className="overflow-hidden  border border-stone-200/80 bg-white shadow-xs   p-6 sm:p-8 lg:p-10">
            ...
            {article?.articlesEssaysQRCodeScen && (
              <div className="mt-10  border border-[#E5A93C]/30 bg-[#fdfbf7] p-5 sm:p-7   shadow-xs">
                ...
                <div className="mt-5 flex flex-col sm:flex-row items-center gap-5">
                  <Link
                    to="/articles"
                    className="inline-flex items-center justify-center  bg-[#E5A93C] px-5 py-2.5 text-sm font-semibold text-stone-950 shadow-xs transition hover:bg-[#d6982b]"
                  >
                    সব লেখা দেখুন
                  </Link>

                  {article.articlesEssaysQRCodeScenImg && (
                    <div className="overflow-hidden  border border-stone-200/80 bg-white p-2  ">
                      <img

        ...
        <div className="w-full">
          ...
          <article className="overflow-hidden rounded-3xl border border-stone-200/80 bg-white shadow-xs   p-6 sm:p-8 lg:p-10">
            ...
            {article?.articlesEssaysQRCodeScen && (
              <div className="mt-10 rounded-2xl border border-[#E5A93C]/30 bg-[#fdfbf7] p-5 sm:p-7   shadow-xs">
                ...
                <div className="mt-5 flex flex-col sm:flex-row items-center gap-5">
                  ...
                  {article.articlesEssaysQRCodeScenImg && (
                    <div className="overflow-hidden rounded-2xl border border-stone-200/80 bg-white p-2  ">
                      <img

...
export const LifeLessons = () => {
  ...
  return (
    <main className="min-h-screen bg-[#f5f5f5]  text-slate-900  overflow-x-hidden">
      ...
      <SectionShell id="life-lessons" className="bg-[#f5f5f5] ">
        <SectionHeader
          badge="জীবনের উপলব্ধি"
          title="জীবন থেকে নেওয়া শিক্ষা"
          subtitle="জীবনযাত্রার ঘটনা, উপলব্ধি ও অভিজ্ঞতা থেকে পাওয়া মূল্যবান শিক্ষা ও দিকনির্দেশনা।"
          align="center"
        />

...
export const Miscellaneous = () => {
    const { data, isLoading, isError } = useQuery({
        ...
        queryFn: async () => {
            const response = await axios.get('https://server-iota-ebon-83.vercel.app/api/v1/miscellaneous/');
    ...
    return (
        <div className="py-10">
            ...
            <div className="container mx-auto px-4 max-w-screen-xl">
                <h1 className="text-3xl font-bold text-center mb-10 text-gray-800 dark:text-white">বিবিধ ভিডিও</h1>

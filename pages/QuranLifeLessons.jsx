...
export const QuranLifeLessons = () => {
  ...
  return (
    <main className="min-h-screen bg-[#f5f5f5] dark:bg-[#0f1117] text-slate-900 dark:text-slate-50 overflow-x-hidden">
      <Title title="কুরআন থেকে জীবনের পাঠ — মাওলানা উবায়দুল্লাহ তাসনিম" />
      ...
      <SectionShell id="quran-lessons" className="bg-[#f5f5f5] dark:bg-[#0f1117]">
        <SectionHeader
          ...
          subtitle="পবিত্র কুরআনের আলোকোজ্জ্বল নির্দেশনা ও আয়াত থেকে আমাদের দৈনন্দিন জীবনের শিক্ষা ও আত্মশুদ্ধি।"
          align="center"
        />
          ...
          <>
                ...
                >
                  ...
                  >
                    <img
                      ...
                      src={lesson.quranLessonImg || Logo}
                  ...
                  <div className="flex flex-1 flex-col p-5 sm:p-6">
                    ...
                    <div className="mt-2.5 flex items-center gap-1.5 text-xs text-stone-500 dark:text-stone-400">
                      ...
                      <span className="flex items-center gap-1">
                        ...
                        <span>{Time(lesson.quranLessonCreateAt)}</span>
                      </span>
                    </div>
            ...
            <Pagination
              ...
              onPageChange={(page) => {
                ...
                const el = document.getElementById("quran-lessons");
...
export default QuranLifeLessons;
